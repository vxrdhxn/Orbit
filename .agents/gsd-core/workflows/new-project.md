...
```bash
if [ "$RUNTIME" = "codex" ]; then INSTRUCTION_FILE="AGENTS.md"; else INSTRUCTION_FILE=".agents/GEMINI.md"; fi
```
...
- `.planning/ROADMAP.md`
- `.planning/STATE.md`
- `$INSTRUCTION_FILE` (`AGENTS.md` for Codex, `.agents/GEMINI.md` for all other runtimes)
...
- [ ] `$INSTRUCTION_FILE` generated with GSD workflow guidance (AGENTS.md for Codex, `.agents/GEMINI.md` otherwise; an existing hand-crafted file without GSD markers is left untouched unless `--force`)
